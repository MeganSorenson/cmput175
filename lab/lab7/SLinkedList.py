...
class SLinkedList:
    ...
    def insert(self, pos, item):
        ...
        # create new node with none as the refrence to the next node
        new_node = SLinkedListNode(item, None)
        ...
        # and adjust the node references as necesssary
            ...
            # get the head of the linked list to start traversal
            current = self.head
            for i in range(pos - 1):
                current = current.getNext()
            # get next node to assign to new node
